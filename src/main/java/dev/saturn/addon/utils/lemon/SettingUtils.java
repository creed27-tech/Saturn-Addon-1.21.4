...
public class SettingUtils {
    ...
    public static dev.saturn.addon.utils.PlaceData getPlaceDataANDDir(BlockPos pos, Predicate<Direction> predicate) {return facing.getPlaceDataAND(pos, predicate, null, true);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataANDPos(BlockPos pos, Predicate<BlockPos> predicate) {return facing.getPlaceDataAND(pos, null, predicate,true);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataAND(BlockPos pos, Predicate<Direction> predicateDir, Predicate<BlockPos> predicate) {return facing.getPlaceDataAND(pos, predicateDir, predicate,true);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataOR(BlockPos pos, Predicate<BlockPos> predicate) {return facing.getPlaceDataOR(pos, predicate, true);}
    public static dev.saturn.addon.utils.PlaceData getPlaceData(BlockPos pos, boolean ignoreContainers) {return facing.getPlaceData(pos, ignoreContainers);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataANDDir(BlockPos pos, Predicate<Direction> predicate, boolean ignoreContainers) {return facing.getPlaceDataAND(pos, predicate, null, ignoreContainers);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataANDPos(BlockPos pos, Predicate<BlockPos> predicate, boolean ignoreContainers) {return facing.getPlaceDataAND(pos, null, predicate, ignoreContainers);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataAND(BlockPos pos, Predicate<Direction> predicateDir, Predicate<BlockPos> predicate, boolean ignoreContainers) {return facing.getPlaceDataAND(pos, predicateDir, predicate, ignoreContainers);}
    public static dev.saturn.addon.utils.PlaceData getPlaceDataOR(BlockPos pos, Predicate<BlockPos> predicate, boolean ignoreContainers) {return facing.getPlaceDataOR(pos, predicate, ignoreContainers);}
    ...
    public static boolean shouldAttackTrace(RotationType attacking) {return raytrace.attackTrace.get();}
    ...
    public static boolean attackTrace(Box bb) {
        return !shouldAttackTrace(RotationType.Attacking) || raytrace.attackTrace(bb);
    }
    ...
    public static boolean shouldRotate(RotationType rotationType) {
        return false;
    }
}