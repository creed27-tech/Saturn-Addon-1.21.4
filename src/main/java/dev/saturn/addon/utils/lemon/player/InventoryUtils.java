...
public class InventoryUtils {
    ...
    public static boolean invSwitch(int slot) throws InterruptedException {
        if (slot >= 0) {
            ...
            ((IClientPlayerInteractionManager) mc.interactionManager).wait();
    ...
    public static void swapBack() throws InterruptedException {
        ScreenHandler handler = mc.player.currentScreenHandler;
        Int2ObjectArrayMap<ItemStack> stack = new Int2ObjectArrayMap<>();
