package dev.saturn.addon.utils.lemon.player;
...
import static dev.saturn.addon.utils.lemon.world.PredictionUtils.returnPredictVec;
...
public class CrystalUtils {
    ...
    public static double crystalDamage(PlayerEntity player, Vec3d crystal, boolean predictMovement, boolean collision, int i, BlockPos obsidianPos, boolean ignoreTerrain) {
        ...
        if (predictMovement)  ((IVec3d) vec3d).meteor$set(pVec.getX(), pVec.getY(), pVec.getZ());
