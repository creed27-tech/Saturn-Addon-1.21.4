...
import dev.saturn.addon.modules.Chat.RNotificationSettings;
import dev.saturn.addon.utils.reaper.services.NotificationManager;
...
public class ReaperModule extends Module {
    ...
    public void info(Text message) {
        RNotificationSettings ns = Modules.get().get(RNotificationSettings.class);
