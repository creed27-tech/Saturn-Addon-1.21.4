package dev.saturn.addon.utils.bed.port.advance;


import meteordevelopment.meteorclient.MeteorClient;
import dev.saturn.addon.modules.Combat.BedBomb;
...
import static dev.saturn.addon.utils.bed.port.advance.PacketUtils.startPacketMine;
import static dev.saturn.addon.utils.bed.port.advance.PredictionUtils.returnPredictBox;
import static dev.saturn.addon.utils.bed.port.advance.PredictionUtils.returnPredictVec;
...
public class BedUtils {
    ...
    public static boolean canBed(BlockPos canPlace, BlockPos replace) {
        return getBlock(canPlace) instanceof BedBlock && getBlock(replace) instanceof BedBlock || BlockUtils.canPlace(canPlace) && mc.world.getBlockState(replace).getBlock() instanceof BedBlock;
    }
