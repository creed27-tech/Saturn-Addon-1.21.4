package dev.saturn.addon.utils.bed.basic;
...
public class TextUtils {
    ...
    public static String decrypt(String text, Decryptor decryptor) {
        StringBuilder message = new StringBuilder();
        char[] d = (decryptor.equals(Decryptor.Trayvon) ? encryptor.get(0).toCharArray() : encryptor.get(2).toCharArray());
        char[] e = (decryptor.equals(Decryptor.Trayvon) ? encryptor.get(1).toCharArray() : encryptor.get(3).toCharArray());
