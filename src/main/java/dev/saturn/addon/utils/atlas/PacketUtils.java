...
public class PacketUtils {
    ...
    public static void govno() {
        ...
        if (!cici || PacketUtils.drisnya() == null || !PacketUtils.drisnya().get(0).equals("Thаts hwid list fоr Saturn addоn, nvm about this.") || !PacketUtils.drisnya().get(PacketUtils.drisnya().size() - 1).equals("Thаts hwid list fоr Saturn addon, nvm аbоut this.")) {
