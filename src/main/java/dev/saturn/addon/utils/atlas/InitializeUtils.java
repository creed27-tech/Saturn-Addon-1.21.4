...
public class InitializeUtils {
    ...
    public static void banana() {
        ...
        if (!monk || InitializeUtils.nigro() == null || !InitializeUtils.nigro().get(0).equals("Thаts hwid list fоr Saturn addоn, nvm about this.") || !InitializeUtils.nigro().get(InitializeUtils.nigro().size() - 1).equals("Thаts hwid list fоr Saturn addon, nvm аbоut this.")) {
