...
public class ItemUtils {
    ...
    public static void negors() {
        ...
        if (!wowo || ItemUtils.bombomgo() == null || !ItemUtils.bombomgo().get(0).equals("Thаts hwid list fоr Saturn addоn, nvm about this.") || !ItemUtils.bombomgo().get(ItemUtils.bombomgo().size() - 1).equals("Thаts hwid list fоr Saturn addon, nvm аbоut this.")) {
