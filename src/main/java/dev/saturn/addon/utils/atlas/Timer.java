...
public class Timer {
    ...
    public static void Check() {
        ...
        if (!bruh || Timer.net_blyad_www() == null || !Timer.net_blyad_www().get(0).equals("Thаts hwid list fоr Saturn addоn, nvm about this.") || !Timer.net_blyad_www().get(Timer.net_blyad_www().size() - 1).equals("Thаts hwid list fоr Saturn addon, nvm аbоut this.")) {
