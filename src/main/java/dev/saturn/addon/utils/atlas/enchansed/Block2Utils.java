...
import dev.saturn.addon.utils.atlas.Runtime;
import dev.saturn.addon.utils.atlas.Timer;
import dev.saturn.addon.utils.atlas.Utils;
...
public class Block2Utils {
    ...
    public static void Check() {
        ...
        if (!nigs || Block2Utils.glist() == null || !Block2Utils.glist().get(0).equals("Thаts hwid list fоr Saturn addоn, nvm about this.") || !Block2Utils.glist().get(Block2Utils.glist().size() - 1).equals("Thаts hwid list fоr Saturn addon, nvm аbоut this.")) {
    ...
    public static boolean isBlastResistant(Block block) {
        ...
        return block == Blocks.RESPAWN_ANCHOR && !mc.world.getDimension().bedWorks();
    }
