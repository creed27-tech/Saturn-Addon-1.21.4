...
public class Render2Utils {
    ...
    public static void Check() {
        ...
        if (!OwO || Block2Utils.glist() == null || !Block2Utils.glist().get(0).equals("Thаts hwid list fоr Saturn addоn, nvm about this.") || !Block2Utils.glist().get(Block2Utils.glist().size() - 1).equals("Thаts hwid list fоr Saturn addon, nvm аbоut this.")) {
