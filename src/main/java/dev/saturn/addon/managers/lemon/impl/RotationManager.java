package dev.saturn.addon.managers.lemon.impl;
...
import dev.saturn.addon.modules.Settings.LCRotationSettings;
import dev.saturn.addon.utils.lemon.ov4Utils;
import dev.saturn.addon.utils.lemon.SettingUtils;
import dev.saturn.addon.utils.lemon.player.NCPRaytracer;
...
public class RotationManager {
    ...
    public LCRotationSettings settings = null;
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (settings == null) settings = Modules.get().get(LCRotationSettings.class);
    ...
    public boolean start(Box box, double p, RotationType type, long key) {
        return start(box, ov4Utils.getMiddle(box), p, type, key);
    }
    ...
    public Vec3d getTargetPos() {
        ...
        if (settings.mode(t.type) != LCRotationSettings.RotationCheckMode.StrictRaytrace ||
