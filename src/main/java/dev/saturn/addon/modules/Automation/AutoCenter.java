...
import static dev.saturn.addon.utils.Automation.HIGUtils.getHighway;
...
public class AutoCenter extends Module {
    ...
    public AutoCenter() {
        super(Saturn.Automation, "auto-center", "Automatically centers the player so that HighwayBorers mine on axis.");
    }
