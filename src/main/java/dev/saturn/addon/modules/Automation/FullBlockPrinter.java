...
public class FullBlockPrinter extends Module {
    ...
    public FullBlockPrinter() {
        super(Saturn.Automation, "full-block-printer", "Automatically builds 2D full-block maps from nbt files.");
    }
    ...
    private boolean tryPlacingBlock(BlockPos pos) {
        ...
        if (lastSwappedMaterial == material)       //Wait for swapped material
