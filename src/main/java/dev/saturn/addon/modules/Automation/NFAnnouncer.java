...
public class NFAnnouncer extends Module {
    ...
    public NFAnnouncer() {
        super(Saturn.Automation, "NF-announcer", "Sends the amount of netherrack blocks you've broken in chat.");
    }
    ...
    public void onTick(TickEvent.Post event) {
        ...
        if (ticks == 0 && count != 0) {
            mc.player.sendMessage(Text.of("I just broke " + count + " blocks of netherrack with the power of Saturn!"), false);
            initialCount = count;
        }
        ticks--;
    }
