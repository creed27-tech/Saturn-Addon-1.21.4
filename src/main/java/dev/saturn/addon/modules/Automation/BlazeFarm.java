...
public class BlazeFarm extends Module {
    ...
    public BlazeFarm() {
        super(Saturn.Automation, "blaze-farm", "Automatically farms Blazes");
    }
    ...
    private boolean entityCheck(Entity entity) {
        // Check if the entity is the player or the camera entity
        ...
        // Check if the entity is not a Blaze
        if (entity.getType() != EntityType.BLAZE) {

        }

        // Check if the entity is not visible or within wall range
