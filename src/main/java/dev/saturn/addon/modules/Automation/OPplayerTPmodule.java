...
public class OPplayerTPmodule extends Module {
    ...
    public OPplayerTPmodule() {
        super(Saturn.Automation, "OP-player-TP-module", "**REQUIRES OP** Teleports you to each player on the server with a button press if keybound, or teleport people to you.");
    }
