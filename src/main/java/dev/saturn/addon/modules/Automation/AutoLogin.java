...
import dev.saturn.addon.settings.StringMapSetting;
import dev.saturn.addon.utils.PulseUtils;
...
public class AutoLogin extends Module {
    ...
    public AutoLogin() {
        super(Saturn.Automation, "auto-login", "Runs command when joining specified server.");
        runInMainMenu = true;
    }
