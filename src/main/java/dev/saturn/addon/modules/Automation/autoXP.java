...
import dev.saturn.addon.utils.MathUtils;
...
public class autoXP extends Module {
    ...
    public autoXP() {
        super(Saturn.Automation, "Auto-XP+", "Automatically interacts with xp bottles to repair armour");
    }
