...
import dev.saturn.addon.modules.Build.ScaffoldHIG;
...
public class OffhandManager extends Module {
    ...
    public OffhandManager() {
        super(Saturn.Automation, "offhand-manager", "Automatically manages your offhand (optimized for highway work).");
    }
