...
import dev.saturn.addon.utils.capy.cLogUtils;
import dev.saturn.addon.utils.capy.LogoutSpotsPlus.Entry;
import dev.saturn.addon.utils.capy.LogoutSpotsPlus.GhostPlayer;
...
import dev.saturn.addon.utils.capy.cPlayerUtils;

import java.util.ArrayList;
import java.util.List;

public class CLogoutSpotsPlus extends Module {
    ...
    public CLogoutSpotsPlus() {
        super(Saturn.PVP, "C-logout-spots-plus", "a better logout spots module");
    }
            ...
            if (!stillOnline) {
                for (PlayerEntity player : lastPlayers) {
                    if (player.getUuid().equals(lastEntry.getProfile().getId())) {
                        ...
                        if (popCounter.get()) {
                            CPopCounter popCounter1 = new CPopCounter();
