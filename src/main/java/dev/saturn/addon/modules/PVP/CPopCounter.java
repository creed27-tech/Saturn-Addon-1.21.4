...
import dev.saturn.addon.events.capy.ClientPlayerDeathEvent;
import dev.saturn.addon.events.capy.PlayerDeathEvent;
import dev.saturn.addon.events.capy.TotemPopEvent;
...
public class CPopCounter extends Module {
    ...
    public CPopCounter() {
        super(Saturn.PVP, "C-Pop-counter", "Counts the number of times you have popped someone's totem");
    }
