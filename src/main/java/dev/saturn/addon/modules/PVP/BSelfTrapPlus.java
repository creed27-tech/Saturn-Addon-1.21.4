...
import dev.saturn.addon.utils.bananaplus.PositionUtils;
...
public class BSelfTrapPlus extends Module {
    public enum Mode {
        Full,
        Top,
        Side
    ...
    public BSelfTrapPlus() {
        super(Saturn.PVP, "B+-self-trap-plus", "Surrounds your head in blocks to prevent you from taking lots of damage.");
    }
    ...
    BStrafePlus strafe = modules.get(BStrafePlus.class);
    ...
    private void notifySelfTrapBreak(Direction direction, PlayerEntity player) {
        switch (direction) {
            case NORTH -> warning("Your north self trap block is being broken by " + player.getName());
            case EAST -> warning("Your east self trap block is being broken by " + player.getName());
            case SOUTH -> warning("Your south self trap block is being broken by " + player.getName());
            case WEST -> warning("Your west self trap block is being broken by " + player.getName());
        }
    }
