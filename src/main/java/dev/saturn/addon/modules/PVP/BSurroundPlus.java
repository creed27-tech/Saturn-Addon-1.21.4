...
public class BSurroundPlus extends Module {
    public enum Mode {
        Normal,
        Russian,
        RussianPlus
    ...
    public BSurroundPlus() {
        super(Saturn.PVP, "b+-surround-plus", "Surrounds you in blocks to prevent you from taking lots of damage.");
    }
