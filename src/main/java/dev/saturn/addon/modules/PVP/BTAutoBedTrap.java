...
import static dev.saturn.addon.utils.bed.advance.Interaction.*;
...
public class BTAutoBedTrap extends Module {
    ...
    public BTAutoBedTrap() {
        super(Saturn.PVP, "BT-auto-BedTrap", "Automatically places blocks around the bed.");
    }
