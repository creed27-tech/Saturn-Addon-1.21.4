...
public class BHButtonPlace extends Module {
    ...
    public BHButtonPlace() {
        super(Saturn.PVP, "BH-button-place", "Automatically places button in surround and burrow to your opponent.");
    }
