...
public class LCAimAssist extends Module {
    public LCAimAssist() {
        super(Saturn.PVP, "LC-aim-assist", "Automatically aims at entities.");
    }
    ...
    private void onTick(TickEvent.Post event) {
        target = TargetUtils.get(entity -> {
            ...
            if (entity == mc.player || !entities.get().contains(entity.getType()))
