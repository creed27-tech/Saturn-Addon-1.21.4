...
public class BHoleESPPlus extends Module {
    ...
    public BHoleESPPlus() {
        super(Saturn.PVP, "B+-hole-esp-plus", "Displays holes that you will take less damage in.");
    }
    ...
    private boolean validHole(BlockPos pos) {
        if ((ignoreOwn.get() && (mc.player.getBlockPos().equals(pos)))) 

        if (!webs.get() && mc.world.getBlockState(pos).getBlock() == Blocks.COBWEB) 
    ...
    private void onRender(Render3DEvent event) {
        for (BHoleESPPlus.Hole hole : holes) hole.render(event.renderer, shapeMode.get(), height.get(), topQuad.get(), bottomQuad.get());
    }
    ...
    private static class Hole {
        ...
        public Color getTopColor() {
            return switch (this.type) {
                case Other -> Modules.get().get(BHoleESPPlus.class).otherColorTop.get();
                case Bedrock  -> Modules.get().get(BHoleESPPlus.class).bedrockColorTop.get();
                default       -> Modules.get().get(BHoleESPPlus.class).mixedColorTop.get();
            };
        }

        public Color getBottomColor() {
            return switch (this.type) {
                case Other -> Modules.get().get(BHoleESPPlus.class).otherColorBottom.get();
                case Bedrock  -> Modules.get().get(BHoleESPPlus.class).bedrockColorBottom.get();
                default       -> Modules.get().get(BHoleESPPlus.class).mixedColorBottom.get();
            };
        }
