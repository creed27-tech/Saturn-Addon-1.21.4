...
public class BBurrowMiner extends Module {
    ...
    public BBurrowMiner() {
        super(Saturn.PVP, "B+-burrow-miner", "Automatically mines enemy's burrow block.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (!sentMessage && chatInfo.get()) {
            warning("Attempting to burrow mine %s.", target.getName());
            sentMessage = true;
        }
