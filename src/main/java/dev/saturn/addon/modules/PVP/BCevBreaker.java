...
public class BCevBreaker extends Module {
    ...
    public BCevBreaker() {
        super(Saturn.PVP, "B+-cev-breaker", "Break crystals over a holefag's head to deal massive damage!");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        BBananaBomber BBomber = Modules.get().get(BBananaBomber.class);
    ...
    private void mine(BlockPos blockPos, Boolean aBoolean, Boolean aBoolean1) {
    }}