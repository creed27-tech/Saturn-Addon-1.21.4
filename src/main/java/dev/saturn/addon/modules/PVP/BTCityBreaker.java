...
public class BTCityBreaker extends Module {
    ...
    public BTCityBreaker() {
        super(Saturn.PVP, "BT-city-breaker", "Automatically breaks target's surround.");
    }
                ...
                if (useCrystals.get() && CityUtils.getCrystalPos(breakPos, support.get()) != null && crystal.found()) {
                    ...
                    if (support.get() && obsidian.found()) {
                        supportTask.run(() -> {
                            ...
                            mc.interactionManager.interactBlock(mc.player, obsidian.getHand(),
                    ...
                    crystalTask.run(() -> {
                        ...
                        mc.interactionManager.interactBlock(mc.player, crystal.getHand(),
