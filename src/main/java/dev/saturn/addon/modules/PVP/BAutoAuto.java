...
import dev.saturn.addon.modules.PVE.BAntiGhostBlock;
import dev.saturn.addon.modules.PVE.BAutoCityPlus;
...
public class BAutoAuto extends Module {
    ...
    public BAutoAuto() {
        super(Saturn.PVP, "B+-auto-auto", "Automates automation");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        BSurroundPlus SP = modules.get(BSurroundPlus.class);
        BAntiGhostBlock AGB = modules.get(BAntiGhostBlock.class);
        BAutoCityPlus AC = modules.get(BAutoCityPlus.class);
        BBurrowMiner BM = modules.get(BBurrowMiner.class);
