...
import dev.saturn.addon.utils.snail.CombatUtils;
import dev.saturn.addon.utils.snail.MathUtils;
import dev.saturn.addon.utils.snail.WorldUtils;
import dev.saturn.addon.utils.snail.swapUtils;
...
public class SAutoAnchor extends Module {
    ...
    public SAutoAnchor() {
        super(Saturn.PVP, "Anchor aura+", "blows up respawn anchors to damage enemies");
    }
