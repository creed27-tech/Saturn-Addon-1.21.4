...
public class CTNTAura extends Module {
    ...
    public final Setting<CTNTAura.mineMode> breakMode = sgAutoBreak.add(new EnumSetting.Builder<CTNTAura.mineMode>().name("break-mode").defaultValue(mineMode.Normal).visible(() -> autoBreak.get()).build());
    //pause
    ...
    public CTNTAura() {
        super(Saturn.PVP, "C-TNT-aura", "Blows the opps up with the t-a-tnt");
    }
