...
public class BHSphere extends Module {
    ...
    public BHSphere() {
        super(Saturn.PVP, "BH-sphere", "build sphere");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        if ((disableOnJump.get() && (mc.options.jumpKey.isPressed() || mc.player.input.playerInput.sneak())) || (disableOnYChange.get() && mc.player.prevY < mc.player.getY())) {
            toggle();
            return;
        }
