...
public class BTAutoMinecart extends Module {
    ...
    public BTAutoMinecart() {
        super(Saturn.PVP, "BT-auto-bomb", "WIP | Places and blow's up minecarts in the target.");
    }
