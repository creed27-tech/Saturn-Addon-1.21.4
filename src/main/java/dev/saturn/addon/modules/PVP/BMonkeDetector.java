...
public class BMonkeDetector extends Module {
    ...
    public BMonkeDetector() {
        super(Saturn.PVP, "B+-monke-detector", "Checks if the CA target is not burrowed, and isn't surrounded. (To be paired with Banana Bomber)");
    }
