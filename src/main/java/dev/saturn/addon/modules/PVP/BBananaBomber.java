...
public class BBananaBomber extends Module {
    ...
    public BBananaBomber() {
        super(Saturn.PVP, "B+-banana-bomber", "Automatically places and attacks crystals.");
    }
    ...
    private void doPlace() {
        ...
        BlockIterator.register((int) Math.ceil(placeRange.get()), (int) Math.ceil(placeRange.get()), (bp, blockState) -> {
            ...
            ((IBox) box).meteor$set(x + 0.001, y, z + 0.001, x + 0.999, y + (smallBox.get() ? 1 : 2), z + 0.999);
