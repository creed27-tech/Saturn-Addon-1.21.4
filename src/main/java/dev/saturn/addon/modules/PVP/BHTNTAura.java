...
public class BHTNTAura extends Module {
    ...
    public final Setting<BHTNTAura.mineMode> breakMode = sgAutoBreak.add(new EnumSetting.Builder<BHTNTAura.mineMode>().name("break-mode").defaultValue(mineMode.Normal).visible(() -> autoBreak.get()).build());
    //pause
    ...
    public BHTNTAura() {
        super(Saturn.PVP, "BH-TNT-aura", "Plece TNT in player");
    }
