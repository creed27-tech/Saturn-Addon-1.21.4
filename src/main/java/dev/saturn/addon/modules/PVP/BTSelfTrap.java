...
import static dev.saturn.addon.utils.bed.advance.PacketUtils.packetPlace;
import static dev.saturn.addon.utils.bed.basic.BlockInfo.isCombatBlock;
...
public class BTSelfTrap extends Module {
    ...
    public BTSelfTrap() {
        super(Saturn.PVP, "BT-self-trap-plus", "Places obsidian above your head.");
    }
