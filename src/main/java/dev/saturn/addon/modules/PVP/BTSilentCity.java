...
import dev.saturn.addon.utils.bed.advance.CityUtils;
import dev.saturn.addon.utils.bed.advance.Interaction;
import dev.saturn.addon.utils.bed.advance.PacketUtils;
...
import static dev.saturn.addon.utils.bed.advance.RenderUtils.render;
import static dev.saturn.addon.utils.bed.basic.BlockInfo.getState;
import static dev.saturn.addon.utils.bed.basic.BlockInfo.isAir;

public class BTSilentCity extends Module {
    ...
    public BTSilentCity() {
        super(Saturn.PVP, "BT-silent-city", "Auto City Breaker based on silent mining.");
    }
