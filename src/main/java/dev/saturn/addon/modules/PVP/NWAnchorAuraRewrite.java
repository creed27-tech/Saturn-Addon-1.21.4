...
public class NWAnchorAuraRewrite extends Module {
    public NWAnchorAuraRewrite(){
        super(Saturn.PVP,"NW-anchor-aura-rewrite", "WIP | For retards that cant configing | Ported from NotWare");
    }
