...
public class BAutoTrapPlus extends Module {
    public enum TopMode {
        Full,
        Top,
        Side,
    ...
    public BAutoTrapPlus() {
        super(Saturn.PVP, "B+-auto-trap+", "Surround your target with blocks.");
    }
    ...
    private FindItemResult getTargetBlock() {
        return InvUtils.findInHotbar(itemStack -> {
            ...
            return blocks.get().contains(block) || fallbackBlocks.get().contains(block);
        });
    }
