...
public class CAutoCityBoss extends Module {
    ...
    public CAutoCityBoss() {
        super(Saturn.PVP, "C-auto-city-boss", "Automatically mine blocks next to someone's feet.");
    }
    ...
    public void onActivate() {
        ...
        targetPos = dev.saturn.addon.utils.capy.EntityUtils.getCityBlock(target);
