...
import dev.saturn.addon.utils.bananaplus.CommonEnums;
...
public class BAntiSurround extends Module {
    ...
    public BAntiSurround() {
        super(Saturn.PVP, "B+-anti-surround", "Place items inside the enemy's surround to break it.");
    }
