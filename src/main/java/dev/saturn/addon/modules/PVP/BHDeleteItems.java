...
public class BHDeleteItems extends Module {
    public BHDeleteItems() {
        super(Saturn.PVP, "BH-Delete-Items", "In order not to give things to the enemy, turn on this function before death (you need to carry a bucket of lava with you)");
    }
