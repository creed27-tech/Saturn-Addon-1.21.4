...
public class BHAntiSurroundBlocks extends Module {
    ...
    //modes
    public final Setting<BHAntiSurroundBlocks.Mode> mode = sgMode.add(new EnumSetting.Builder<BHAntiSurroundBlocks.Mode>().name("Mode").description("AntiSurroundBlocks mode.").defaultValue(BHAntiSurroundBlocks.Mode.Button).build());
    //render
    ...
    public BHAntiSurroundBlocks() {
        super(Saturn.PVP, "BH-anti-surround-blocks", "Automatically trying to fuck players surround.");
    }
