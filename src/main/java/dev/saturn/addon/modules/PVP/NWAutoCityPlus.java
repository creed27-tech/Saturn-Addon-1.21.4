...
import dev.saturn.addon.utils.notware.combat.NotwareUtils;
...
public class NWAutoCityPlus extends Module {
    ...
    public NWAutoCityPlus() {
        super(Saturn.PVP, "NW-auto-city-plus", "yes | Ported from NotWare");
    }
    ...
    private void interact(BlockPos pos, FindItemResult item, Direction direction) {
        ...
        if (silentSwitch.get() && item.getHand() != null) {
            mc.interactionManager.interactBlock(
                    mc.player,
                    item.getHand(),
                    new BlockHitResult(mc.player.getPos(), direction, pos, true)
            );
    ...
    public String getInfoString() {
        return target != null ? String.valueOf(target.getName()) : null;
    }
