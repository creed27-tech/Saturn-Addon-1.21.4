...
public class BHPIRAMIDKA extends Module {
    ...
    public BHPIRAMIDKA() {
        super(Saturn.PVP, "BH-PIRAMIDKA", "for hard pvp moments");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        if ((disableOnJump.get() || (disableOnYChange.get() && mc.player.prevY < mc.player.getY()))) {
            toggle();
            return;
        }
