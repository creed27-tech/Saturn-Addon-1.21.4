...
public class BTHoleFill extends Module {
    ...
    public BTHoleFill() {
        super(Saturn.PVP, "BT-hole-fill", "Automatically fills holes around target.");
    }
    ...
    private void packetPlace(BlockPos pos) {
        if (pos != null) {
            ...
            // Sending the packet with the correct number of parameters
