...
import dev.saturn.addon.utils.capy.Hole.HoleUtils;
...
import dev.saturn.addon.utils.capy.cPlaceBreakUtils;

public class CAntiPistonPush extends Module {
    ...
    public CAntiPistonPush() {
        super(Saturn.PVP, "C-anti-piston-push", "Prevent getting pushed by pistons.");
    }
