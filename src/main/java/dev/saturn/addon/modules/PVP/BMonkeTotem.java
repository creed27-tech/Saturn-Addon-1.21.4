...
import dev.saturn.addon.utils.bananaplus.BPlusDamageUtils;
...
public class BMonkeTotem extends Module {
    public enum Mode {
        Smart,
        Strict
    }
    ...
    public BMonkeTotem() {
        super(Saturn.PVP, "B+-monke-totem", "Automatically puts a totem in your offhand.");
    }
