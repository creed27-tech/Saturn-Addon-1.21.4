...
public class BTOldSurround extends Module {
    ...
    public BTOldSurround() {
        super(Saturn.PVP, "BT-old-surround", "Surrounds you in blocks to prevent you from taking lots of damage.");
    }
