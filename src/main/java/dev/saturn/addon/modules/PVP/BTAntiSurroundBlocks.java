...
public class BTAntiSurroundBlocks extends Module {
    ...
    //modes
    public final Setting<BTAntiSurroundBlocks.Mode> mode = sgMode.add(new EnumSetting.Builder<BTAntiSurroundBlocks.Mode>().name("Mode").description("AntiSurroundBlocks mode.").defaultValue(BTAntiSurroundBlocks.Mode.Button).build());
    //render
    ...
    public BTAntiSurroundBlocks() {
        super(Saturn.PVP, "BT-AntiSurroundBlocks", "Automatically trying to fuck players surround.");
    }
