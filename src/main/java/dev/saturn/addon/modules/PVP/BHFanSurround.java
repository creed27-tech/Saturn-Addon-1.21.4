...
import dev.saturn.addon.utils.bebra.BlockHelper;
...
public class BHFanSurround extends Module {
    ...
    public BHFanSurround() {
        super(Saturn.PVP, "BH-fan-surround", "Fan Surround i guess.");
    }

    public BHFanSurround(Category category, String name, String description) {
