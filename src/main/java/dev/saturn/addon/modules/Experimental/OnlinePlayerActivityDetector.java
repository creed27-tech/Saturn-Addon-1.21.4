...
public class OnlinePlayerActivityDetector extends Module {
    ...
    public OnlinePlayerActivityDetector() {
        super(Saturn.Experimental,"OnlinePlayerActivityDetector", "Detects if an online player is still nearby if there are blocks missing from a BlockState palette and your render distances are overlapping.");
    }
    @Override
