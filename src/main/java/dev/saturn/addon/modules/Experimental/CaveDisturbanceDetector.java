...
public class CaveDisturbanceDetector extends Module {
    ...
    public CaveDisturbanceDetector() {
        super(Saturn.Experimental,"CaveDisturbanceDetector", "Scans for single air blocks within the cave air blocks found in caves and underground structures in 1.13+ chunks. There are several false positives.");
    }
