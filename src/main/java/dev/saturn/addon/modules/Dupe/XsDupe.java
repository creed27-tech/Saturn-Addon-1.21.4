...
public class XsDupe extends Module {
    ...
    public XsDupe() {
        super(Saturn.Dupe, "xs-dupe", "Attempts to dupe by desyncing and doing multiple actions.");
    }
    ...
    public void onActivate() {
        ...
        if (sendMsg.get())
            ChatUtils.sendPlayerMsg("I am currently performing the XsDupe on Saturn.");
