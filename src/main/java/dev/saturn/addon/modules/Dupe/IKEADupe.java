...
import dev.saturn.addon.utils.ikea.TimerUtils;
...
import static dev.saturn.addon.utils.ikea.PacketUtils.dismountPackets;

public class IKEADupe extends Module {

    public IKEADupe(){
        super(Saturn.Dupe,"IKEA-dupe-2.0","Does the updated IKEA dupe.");
    }
