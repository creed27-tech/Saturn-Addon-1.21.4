...
import dev.saturn.addon.managers.lemon.impl.RotationManager;
...
public class LCRotationSettings extends ov4Module {
    public LCRotationSettings() {
        super(Saturn.Settings, "LC-rotate", "Global rotation settings for every ov4 module.");
    }
    ...
    public boolean raytraceCheck(Vec3d pos, double y, double p, Box box) {
        double range = pos.distanceTo(ov4Utils.getMiddle(box)) + 3;
