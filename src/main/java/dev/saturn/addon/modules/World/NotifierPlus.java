...
import dev.saturn.addon.utils.orcrist.misc.PacketManager;
import dev.saturn.addon.utils.orcrist.misc.Placeholders;
import dev.saturn.addon.utils.orcrist.player.ArmorUtils;
import dev.saturn.addon.utils.orcrist.player.CombatHelper;
...
public class NotifierPlus extends Module {
    ...
    public NotifierPlus() {
        super(Categories.World, "notifier+", "Notifies you of different events.");
    }
