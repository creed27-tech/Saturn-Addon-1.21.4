package dev.saturn.addon.modules.Movement.elytrafly;

import dev.saturn.addon.modules.Movement.elytrafly.modes.Pitch40;
...
import dev.saturn.addon.modules.Movement.elytrafly.modes.Control;
import dev.saturn.addon.modules.Movement.elytrafly.modes.Wasp;
...
public class ElytraFlyPlus extends Module {
    ...
    private void onModeChanged(ElytraFlyModes mode) {
        switch (mode) {
            ...
            case Pitch40 -> currentMode = new Pitch40();
        }
    }
}