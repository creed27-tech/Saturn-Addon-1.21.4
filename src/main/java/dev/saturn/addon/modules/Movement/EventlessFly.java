...
import dev.saturn.addon.utils.ServerUtils;
...
public class EventlessFly extends Module{
    ...
    public EventlessFly() {
        super(Categories.Movement, "eventless-fly", "Allows you to fly without triggering events.");
    }
    ...
    public void onDeactivate() {
        if (cancelRotations.get() && resetRotationOnDisable.get()) {
            ...
            mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(cameraYaw, cameraPitch, mc.player.isOnGround(), false));
        }
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(endPos.x, endPos.y, endPos.z, mc.player.isOnGround(), false));
        mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.PositionAndOnGround(endPos.x, -1E6, endPos.z, false, false));
    }
}
