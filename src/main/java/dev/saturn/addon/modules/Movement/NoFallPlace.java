...
import dev.saturn.addon.mixininterfaces.bidoof.IJesus;
import dev.saturn.addon.mixininterfaces.bidoof.INoFall;
import dev.saturn.addon.utils.bidoof.ChatUtils;
...
public class NoFallPlace extends Module {
    ...
    public NoFallPlace() {
        super(Categories.Movement, "no-fall-place", "Prevent fall damage by placing blocks.");
    }
    ...
    protected static boolean hasFrostWalker() {
        ...
        return EnchantmentHelper.getLevel((RegistryEntry<Enchantment>) Enchantments.FROST_WALKER, boots) >= 1;
    }
