...
public class StrictNoSlow extends Module {
    public StrictNoSlow() {
        super(Categories.Movement, "strict-no-sow", "Should only be used on very strict servers. Requires any other noslow to work.");
    }
    ...
    private void sendPacket(UpdateSelectedSlotC2SPacket updateSelectedSlotC2SPacket) {
    }
