...
public class StrafePlus extends ov4Module {
    public StrafePlus() {
        super(Categories.Movement, "Strafe+", "Increase speed and control. | Ported from Lemon Client");
    }
    ...
    private Vector2d transformStrafe(double speed) {
        ...
        float yaw = mc.player.prevYaw + (mc.player.getYaw() - mc.player.prevYaw) * mc.getTaskCount();
