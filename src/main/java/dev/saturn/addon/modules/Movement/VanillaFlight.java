...
import dev.saturn.addon.utils.antip2w.MCUtil;
...
public class VanillaFlight extends Module {
    ...
    public VanillaFlight() {
        super(Categories.Movement, "vanilla-flight", "A Redbull szááárnyakat ad!");
    }
    ...
    private boolean canMoveHorizontally(double amount) {
        ...
        if (mc.world.getBlockCollisions(null, boundingBox).iterator().hasNext()) 
        return true;
        return false;
    }
    ...
    private void onPlayerMove(PlayerMoveEvent event) {
        ((IVec3d)mc.player.getVelocity()).meteor$set(jesse_we_need_to_cook.x, jesse_we_need_to_cook.y, jesse_we_need_to_cook.z);
    }
}