...
import dev.saturn.addon.events.proxima.PlayerMoveEvent;
import dev.saturn.addon.events.proxima.UpdateWalkingPlayerEvent;
import net.minecraft.entity.effect.StatusEffects;
import net.minecraft.network.packet.c2s.play.PlayerMoveC2SPacket;
import net.minecraft.util.shape.VoxelShape;
import dev.saturn.addon.utils.proxima.PlayerUtil;
...
public class AirStrafe extends Module {
    public AirStrafe(){
        super(Categories.Movement, "air-strafe", "Im tired of these modules having no description. | Ported from Proxima");
    }
    ...
    public void onMove(PlayerMoveEvent event) {
        if (mc.player.isOnGround() || mc.player.isGliding() || mc.player.getAbilities().flying) return;
