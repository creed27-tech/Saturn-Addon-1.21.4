...
import dev.saturn.addon.utils.zewo2.JinxUtils;
import dev.saturn.addon.utils.zewo2.Line;
...
public class StrongholdFinder extends Module {
    ...
    public StrongholdFinder() {
        super(Categories.Misc, "stronghold-finder", "Triangulation Stronghold location");
    }
