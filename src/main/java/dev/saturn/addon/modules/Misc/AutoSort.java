...
public class AutoSort extends VHModuleHelper {
    ...
    public AutoSort() {
        super(Categories.Misc, "auto-sort-vh", "Sorts your inventory. May cause desync on some servers. | Ported from Venomhack");
    }
