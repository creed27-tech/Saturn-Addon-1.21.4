...
import dev.saturn.addon.utils.lemon.player.CraftUtils;
...
import static dev.saturn.addon.utils.lemon.entity.EntityInfo.isInHole;
import static dev.saturn.addon.utils.lemon.entity.EntityInfo.isMoving;
import static dev.saturn.addon.utils.lemon.misc.Vec3dInfo.closestVec3d;
import static dev.saturn.addon.utils.lemon.player.CraftUtils.getEmptySlots;
import static dev.saturn.addon.utils.lemon.player.CraftUtils.isInventoryFull;
import static dev.saturn.addon.utils.lemon.world.BlockInfo.getBlock;
import static dev.saturn.addon.utils.lemon.world.BlockInfo.getSphere;

public class BedCrafter extends ov4Module {
    public BedCrafter() {
        super(Categories.Misc, "bed-crafter", "Automatically craft beds. | Ported from Lemon Client");
    }
