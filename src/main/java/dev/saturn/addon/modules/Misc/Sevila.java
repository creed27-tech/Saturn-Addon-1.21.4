...
import dev.saturn.addon.modules.Combat.BedAura;
import meteordevelopment.meteorclient.events.world.TickEvent;
import dev.saturn.addon.modules.Combat.XPThrower;
...
public class Sevila extends Module {
    ...
    public Sevila() {
        super(Categories.Misc, "Sevila", "Rotates around and got some players mad.");
    }
    ...
    public void onTick(TickEvent.Post event) {
        ...
        switch (antiDesync.get()) {
            case All -> {
                if (Modules.get().isActive(XPThrower.class) ||
