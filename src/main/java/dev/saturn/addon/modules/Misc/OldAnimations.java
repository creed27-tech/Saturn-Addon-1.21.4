...
import dev.saturn.addon.events.reaper.UpdateHeldItemEvent;
import dev.saturn.addon.mixin.reaper.HeldItemRendererAccessor;
...
public class OldAnimations extends ReaperModule {
    ...
    public OldAnimations() {
        super(Categories.Misc, "old-animations", "Changes hit animations to those of 1.8. | Ported from Reaper");
    }
