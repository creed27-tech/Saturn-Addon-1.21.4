...
public class PearlPredict extends VHModuleHelper {
    ...
    public PearlPredict() {
        super(Categories.Misc, "pearl-predict-vh", "Predicts accurately where ender pearls will land. | Ported from Venomhack");
    }
