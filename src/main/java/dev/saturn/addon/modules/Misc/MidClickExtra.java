...
public class MidClickExtra extends ov4Module {
    public MidClickExtra() {
        super(Categories.Misc, "mid-click-extra", "Lets you use items when you middle click. | Ported from Lemon Client");
    }
        ...
        switch (switchMode.get()) {
            ...
            case InvSwitch -> {
                try {
                    ...
                    e.printStackTrace(); // Handle the exception (e.g., log it, rethrow it, etc.)
                }
            }
