...
import dev.saturn.addon.modules.Misc.RivalsPlayers;
...
public class RivalsKingdoms extends Module {
    ...
    public RivalsKingdoms() {
        super(Categories.Misc, "captured-chunks", "Shows you captured chunks on Rivals Kingdoms servers. (use RivalsNocom to config)");
    }
