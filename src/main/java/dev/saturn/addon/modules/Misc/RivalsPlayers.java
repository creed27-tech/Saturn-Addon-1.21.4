...
import dev.saturn.addon.utils.antip2w.RivalsUtils.PlayerData;
import dev.saturn.addon.utils.antip2w.RivalsUtils.RivalsRequestException;
...
import static dev.saturn.addon.utils.antip2w.RivalsUtils.OpKingdomWorld;
import static dev.saturn.addon.utils.antip2w.RivalsUtils.getPlayerData;
...
public class RivalsPlayers extends Module {
    ...
    public RivalsPlayers() {
        super(Categories.Misc, "rivals-nocom", "Shows player's locations lol .");
    }
