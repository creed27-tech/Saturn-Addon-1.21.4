...
import dev.saturn.addon.utils.reaper.misc.ModuleHelper;
...
public class StrictMove extends ReaperModule {
    ...
    public StrictMove() {
        super(Categories.Misc, "strict-move", "Mitigate lag-back from modules and/or strict anti-cheat. | Ported from Reaper");
    }
