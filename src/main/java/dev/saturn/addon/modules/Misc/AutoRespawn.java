...
import dev.saturn.addon.utils.reaper.misc.MessageUtil;
import dev.saturn.addon.utils.reaper.player.Stats;
import dev.saturn.addon.utils.reaper.services.GlobalManager;
...
public class AutoRespawn extends ReaperModule {
    ...
    public AutoRespawn() {
        super(Categories.Misc, "auto-respawn", "Automatically respawns after death. | Ported from Reaper");
    }
