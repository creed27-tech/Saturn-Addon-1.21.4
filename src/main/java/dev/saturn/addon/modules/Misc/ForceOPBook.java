...
public class ForceOPBook extends Module {
    ...
    public ForceOPBook() {
        super(Categories.Misc, "force-op-book", "Requires Creative mode! Creates a Book that can run commands in your inventory. Give it to someone with OP and have them click on the page in the book.");
    }
