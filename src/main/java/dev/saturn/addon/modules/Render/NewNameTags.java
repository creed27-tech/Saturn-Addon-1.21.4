...
import dev.saturn.addon.events.aurora.Render2DEvent;
...
public class NewNameTags extends Module {
    ...
    public NewNameTags() {
        super(Categories.Render, "new-nametags" , "1. | Ported from Aurora");
    }
    ...
    private  void  drawText(DrawContext context, String  text, Vec3d vec)  {
        ...
        if  (vector.z  >  0  &&  vector.z  <  1)  {
            ...
            // Assuming you have a method to get the matrix stack or push/pop matrix in context.
            MatrixStack matrices = context.getMatrices(); // Assuming there is a public method like this.
            ...
            if (true) {
                ...
                RenderUtils.drawRect(matrices, ((tagX / scale) - 2),
...
// Draw the text
            ...
            matrices.pop(); // Pop the matrix after use
        }
    }
