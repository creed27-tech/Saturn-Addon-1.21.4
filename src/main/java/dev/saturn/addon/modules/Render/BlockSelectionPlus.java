...
public class BlockSelectionPlus extends Module {
    ...
    public BlockSelectionPlus() {
        super(Categories.Render, "block-selection-plus", "Modifies how your block selection is rendered. | Ported from Aurora");
    }
