...
import dev.saturn.addon.utils.reaper.render.ExternalRenderers;
import dev.saturn.addon.utils.reaper.services.SpotifyService;
...
public class ExternalHUD extends Module {
    ...
    public ExternalHUD() {
        super(Categories.Render, "external-hud", "Renders a simple hud outside the client. | Ported from Reaper");
    }
