...
public class VHHoleEsp extends VHModuleHelper {
    ...
    public VHHoleEsp() {
        super(Categories.Render, "VH-hole-esp", "Displays holes that you will take less damage in.");
    }
    ...
    private static class Hole {
        ...
        public Color getColor(boolean bottom, boolean line) {
            VHHoleEsp hesp = Modules.get().get(VHHoleEsp.class);
