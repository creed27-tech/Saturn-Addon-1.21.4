...
import dev.saturn.addon.modules.Combat.AutoCrystalPlus;
...
public class BreakESP extends ov4Module {
    public BreakESP() {
        super(Categories.Render, "break-ESP", "Show the destruction progress of the box. | Ported from Lemon Client");
    }
