...
import dev.saturn.addon.events.Blackout.EventHandler;
...
import dev.saturn.addon.modules.Chat.Roast.Utilsroast;
...
public class Roast extends Module {
    ...
    public Roast() {
        super(Saturn.Chat, "roast", "Insults a random player");
    }
