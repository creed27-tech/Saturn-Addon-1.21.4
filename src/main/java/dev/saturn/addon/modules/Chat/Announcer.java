...
import dev.saturn.addon.utils.bidoof.Constants;
import dev.saturn.addon.utils.bidoof.StarscriptUtils;
...
public class Announcer extends Module {
    ...
    public Announcer() {
        super(Saturn.Chat, "announcer", "Announces specified actions into chat.");
    }
