...
public class BurrowPlus2 extends Module {
    ...
    public BurrowPlus2() {
        super(Categories.Combat, "block-lag", "Places a block inside your feet. | Ported from Aurora");
        ...
        if (this.mc.player != null && this.mc.world != null) {
            if (this.mc.player.isOnGround()) {
                ...
                if (selfPos == null) {
                    ...
                    dev.saturn.addon.utils.PlaceData data = SettingUtils.getPlaceData(selfPos);
                    if (data.valid()) {
