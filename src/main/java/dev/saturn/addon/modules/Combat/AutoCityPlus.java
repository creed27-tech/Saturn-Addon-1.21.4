...
import dev.saturn.addon.utils.Wrapper;
import dev.saturn.addon.utils.orion.BlockHelper;
import dev.saturn.addon.utils.orion.AutomationUtils;
import dev.saturn.addon.utils.orion.ItemHelper;
...
public class AutoCityPlus extends Module {
    ...
    public AutoCityPlus() {
        super(Categories.Combat, "auto-city-plus", "Auto city but better.");
    }
