...
import dev.saturn.addon.events.bbc.BlockUpdateEvent;
import dev.saturn.addon.events.bbc.BreakBlockEvent;
import dev.saturn.addon.utils.bbc.entity.EntityHelper;
import dev.saturn.addon.utils.bbc.entity.TargetHelper;
...
public class BogeyMan extends Module {
    public BogeyMan() {
        super(Categories.Combat, "boogey-man", "Automatically place's and blows up beds. | Ported from BBCWare");
    }
    ...
    private boolean isReplaceable(BlockPosX pos){
        return pos.air() || BlockHelper.getState(pos).getFluidState().isStill() || pos.of(FireBlock.class) || pos.of(Blocks.GRASS_BLOCK) || pos.of(Blocks.TALL_GRASS) || pos.of(Blocks.SEAGRASS);
    }
