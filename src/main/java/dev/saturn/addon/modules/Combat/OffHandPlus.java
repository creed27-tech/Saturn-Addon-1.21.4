...
public class OffHandPlus extends Module {
    public OffHandPlus() {
        super(Categories.Combat, "offhand-plus", "Better offhand.");
    }
    ...
    private void onRender(Render3DEvent event) {
        ...
        if (autoCrystalRewrite == null) {autoCrystalRewrite = Modules.get().get(AutoCrystal.class);}
    ...
    private void move(int slot) {
        if (strict.get()) {
            ...
            autoCrystalRewrite.sendPacket(new PlayerActionC2SPacket(PlayerActionC2SPacket.Action.SWAP_ITEM_WITH_OFFHAND, new BlockPos(0, 0, 0), Direction.DOWN, 0));
