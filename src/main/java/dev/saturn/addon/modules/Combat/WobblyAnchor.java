...
public class WobblyAnchor extends Module {
    ...
    public WobblyAnchor() {
        super(Categories.Combat, "wobbly-anchor", "Anchor that wobbly used (aka best anchor) | Ported from BananaHack");
    }
            ...
            if (isBlockHole(getPlayerPos().down(1)) || isBlockHole(getPlayerPos().down(2)) ||
                ...
                if (!pull.get()) {
                    ...
                    if (XDiff <= 0.1 && ZDiff <= 0.1) {
                        ...
                        ((IVec3d) mc.player.getVelocity()).meteor$set(MotionX/2, mc.player.getVelocity().y, MotionZ/2);
                    }
                }
