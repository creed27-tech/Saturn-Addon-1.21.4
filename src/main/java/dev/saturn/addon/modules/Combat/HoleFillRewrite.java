...
public class HoleFillRewrite extends Module {
    ...
    public HoleFillRewrite() {
        super(Categories.Combat, "hole-fill-rewrite", "Automatically fills holes around target.");
    }
    ...
    private boolean validHole(BlockPos pos) {
        ...
        if (!mc.player.getBlockPos().isWithinDistance(pos, placeRange.get())) 
        ...
        if (!mc.world.canPlace(Blocks.OBSIDIAN.getDefaultState(), pos, ShapeContext.absent())) 
