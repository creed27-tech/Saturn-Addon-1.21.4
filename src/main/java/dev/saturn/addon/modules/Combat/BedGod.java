...
import dev.saturn.addon.events.reaper.DeathEvent;
import dev.saturn.addon.utils.reaper.misc.ReaperModule;
import dev.saturn.addon.utils.reaper.misc.Formatter;
import dev.saturn.addon.utils.reaper.misc.MathUtil;
import dev.saturn.addon.utils.reaper.network.PacketManager;
import dev.saturn.addon.utils.reaper.player.Interactions;
import dev.saturn.addon.utils.reaper.player.Interactions.MineInstance;
import dev.saturn.addon.utils.reaper.render.Renderers.SimpleBedRender;
import dev.saturn.addon.utils.reaper.world.BlockHelper;
import dev.saturn.addon.utils.reaper.world.CombatHelper;
import dev.saturn.addon.utils.reaper.world.DamageCalculator;
import dev.saturn.addon.utils.reaper.world.DamageCalculator.BedPlacement;
...
public class BedGod extends ReaperModule {
    ...
    public BedGod() {
        super(Categories.Combat, "bed-god", "The best bed aura. | Ported from Reaper");
    }
