...
public class OffHando extends Module {
    ...
    public OffHando() {
        super(Categories.Combat, "off-hando", "Automatically puts items in your offhand.");
    }
    ...
    public void onRender(Render3DEvent event) {
        ...
        if (mc.player.playerScreenHandler != mc.player.currentScreenHandler || mc.currentScreen instanceof InventoryScreen || mc.player.isCreative())
            return;
