...
public class SmiteAura extends Module {
    ...
    public SmiteAura() {
        super(Categories.Combat, "smite-aura", "Automatically strikes lighting on specified entities around you");
    }
