package dev.saturn.addon.modules.Combat.killaura.modes;
...
import dev.saturn.addon.modules.Combat.killaura.KillAuraPlusMode;
import dev.saturn.addon.modules.Combat.killaura.KillAuraPlusModes;
import dev.saturn.addon.utils.meteorplus.GameSensitivityUtils;
import dev.saturn.addon.utils.meteorplus.math.StopWatch;
...
import static dev.saturn.addon.modules.Combat.criticals.CriticalsPlus.allowCrit;
import static dev.saturn.addon.modules.Combat.criticals.CriticalsPlus.needCrit;
import static dev.saturn.addon.utils.meteorplus.RaycastUtils.raycastEntity;
...
public class Matrix extends KillAuraPlusMode {
    ...
    private boolean entityCheck(Entity entity) {
        ...
        if (!settings.entities.get().contains(entity.getType())) 
        ...
        if (entity instanceof PlayerEntity player) {
            ...
            if (settings.shieldMode.get() == KillAura.ShieldMode.Ignore && player.blockedByShield(mc.world.getDamageSources().playerAttack(mc.player))) ;
        }
        return true;
    }
