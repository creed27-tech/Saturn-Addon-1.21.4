...
import dev.saturn.addon.utils.atlas.CrystalUtils;
import dev.saturn.addon.utils.atlas.InitializeUtils;
import dev.saturn.addon.utils.atlas.enchansed.Inv2Utils;
...
public class AutoTotemRewrite extends Module {
    public AutoTotemRewrite() {
        super(Categories.Combat, "auto-totem-rewrite", "Description sleeping rn. | Ported from Atlas");
    }
    int x = 0;
    ...
    {
        if (mc.player.isGliding()) return false; // TODO: return false only when speed is enough too pop totem
