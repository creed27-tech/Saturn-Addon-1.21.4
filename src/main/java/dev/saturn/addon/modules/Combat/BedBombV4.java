...
import dev.saturn.addon.utils.lemon.LemonUtils;
...
public class BedBombV4 extends Module {
    public BedBombV4() {
        super(Categories.Combat, "bed-bomb-v4", "WIP | Automatically places and breaks beds to cause damage to your opponents in strict anticheat servers.");
    }
    ...
    private void calculate(int index) {
        ...
        for (int i = lastIndex; i < index; i++) {
            ...
            for (Direction dir : Direction.Type.HORIZONTAL) {
                dev.saturn.addon.utils.PlaceData data = getData(pos, dir);
    ...
    private void interactBlock(Hand hand, Vec3d centerPos, Direction interactDir, BlockPos interactPos) {
    }
    ...
    private dev.saturn.addon.utils.PlaceData getData(BlockPos pos, Direction dir) {
        if (fiveB.get()) {
