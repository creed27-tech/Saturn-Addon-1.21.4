...
import dev.saturn.addon.utils.reaper.combat.CityUtils;
import dev.saturn.addon.utils.reaper.misc.ReaperModule;
import dev.saturn.addon.utils.reaper.misc.Task;
...
public class AntiSurround extends ReaperModule {
    ...
    public AntiSurround() {
        super(Categories.Combat, "anti-surround", "Automatically breaks target's surround. | Ported from Reaper");
    }
