...
import static dev.saturn.addon.utils.OLEPOSSUtils.replaceable;
...
public class AutoCraftingTable extends BlackOutModule {
    public AutoCraftingTable() {
        super(Categories.Combat, "auto-crafting-table", "Automatically places and opens an Crafting table.");
    }
