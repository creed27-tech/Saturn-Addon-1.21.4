...
import dev.saturn.addon.enums.reaper.AntiCheat;
import dev.saturn.addon.enums.reaper.ResistType;
import dev.saturn.addon.enums.reaper.SwingMode;
import dev.saturn.addon.utils.reaper.combat.Placing;
import dev.saturn.addon.utils.reaper.combat.Ranges;
import dev.saturn.addon.utils.reaper.combat.Statistics;
import dev.saturn.addon.utils.reaper.player.Interactions;
import dev.saturn.addon.utils.reaper.player.PlayerUtil;
import dev.saturn.addon.utils.reaper.world.BlockUtil;
...
public class ReaperHoleFill extends Module {
    ...
    public ReaperHoleFill() {
        super(Categories.Combat, "reaper-holefill", "The best way to make your enemies really, REALLY mad. | Ported from Reaper");
    }
