...
import dev.saturn.addon.utils.bana.BEntityUtils;
...
import static dev.saturn.addon.utils.bana.TimerUtils.getTPSMatch;
...
public class XPThrower extends Module {
    ...
    public XPThrower() {
        super(Categories.Combat, "XP-thrower", "Throw XP bottles to repair your armor and tools.");
    }
