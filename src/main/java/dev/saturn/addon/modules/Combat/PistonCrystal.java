...
import static dev.saturn.addon.utils.bed.advance.Interaction.placeBlock;
...
public class PistonCrystal extends Module {
    ...
    private void sendPacket(PlayerActionC2SPacket playerActionC2SPacket) {
    }

    private void sendPacket(PlayerInteractEntityC2SPacket playerActionC2SPacket) {
    }
    ...
    private void interactBlock(Hand hand, Vec3d centerPos, Direction crystalPlaceDir, BlockPos down) {
    }
