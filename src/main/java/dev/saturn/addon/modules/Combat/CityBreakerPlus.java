...
import dev.saturn.addon.utils.bed.port.advance.CityUtils;
...
public class CityBreakerPlus extends Module {
    ...
    public CityBreakerPlus() {
        super(Categories.Combat, "city-breaker-plus", "Automatically breaks target's surround.");
    }
