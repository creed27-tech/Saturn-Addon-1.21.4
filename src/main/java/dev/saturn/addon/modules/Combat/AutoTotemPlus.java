...
public class AutoTotemPlus extends Module {
    ...
    public AutoTotemPlus() {
        super(Categories.Combat, "auto-totem+", "Automatically replenishes your totems. | Ported from Reaper");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        if (totems <= 0) locked = false;
            ...
            boolean ely = mc.player.getEquippedStack(EquipmentSlot.CHEST).getItem() == Items.ELYTRA && mc.player.isGliding();
