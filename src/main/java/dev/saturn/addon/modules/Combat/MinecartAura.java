...
public class MinecartAura extends Module {
    ...
    public MinecartAura() {
        super(Categories.Combat, "minecart-aura", "Automatically does some things with minecarts i guess.");
    }
                    ...
                    case BowFlame -> {
                        ...
                        if (explodeTicks >= explodeDelay.get()) {
                            ...
                            if (bow.isHotbar()) {
                                ...
                                if (mainHandStack.getItem() == Items.BOW && EnchantmentHelper.getLevel((RegistryEntry<Enchantment>) Enchantments.FLAME, mainHandStack) > 0) { // aah yes my brai
