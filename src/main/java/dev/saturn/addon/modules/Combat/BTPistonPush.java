...
import static dev.saturn.addon.utils.bed.port.advance.Interaction.*;
...
public class BTPistonPush extends Module {
    ...
    public BTPistonPush() {
        super(Categories.Combat, "BT-piston-push", "Pushing P.");
    }
