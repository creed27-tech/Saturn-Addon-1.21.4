...
import dev.saturn.addon.utils.OED.EntityUtilsPlus;

import static dev.saturn.addon.utils.OED.TimerUtils.getTPSMatch;
...
public class FastThrowXP extends Module {
    ...
    public FastThrowXP() {
        super(Categories.Combat, "fast-throw-XP", "Throw XP bottles.");
    }
    ...
    private void throwXP(FindItemResult hotbarExp) {
        ...
        if (hotbarExp.isOffhand()) {
            ...
            if (autoSwitch.get() == SwitchMode.Silent)
