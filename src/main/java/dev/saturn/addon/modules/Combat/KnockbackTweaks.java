...
public class KnockbackTweaks extends Module {
    ...
    public KnockbackTweaks() {
        super(Categories.Combat, "knockback-tweaks", "Allows you to change the direction of the knockback received by the entities you hit. (doesn't work with criticals)");
    }
    ...
    private void onTick(TickEvent.Post event) {
        ...
        if (shouldResendLookPacket) {
            ...
            mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(mc.player.getYaw(), mc.player.getPitch(), mc.player.isOnGround(), mc.player.isOnGround()));
        }
    ...
    private void onEntityAttack(AttackEntityEvent event) {
        ...
        mc.player.networkHandler.sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(yaw, mc.player.getPitch(), mc.player.isOnGround(), mc.player.isOnGround()));
