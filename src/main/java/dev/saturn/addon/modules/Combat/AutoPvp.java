...
import dev.saturn.addon.utils.RaksuTone.RaksuPath;
import dev.saturn.addon.utils.RaksuTone.RaksuTone;
...
public class AutoPvp extends BlackOutModule {
    public AutoPvp() {
        super(Categories.Combat, "auto-CC", "Follows people using baritone. Best for crystalpvp.cc | Ported from Blackout");
    }
