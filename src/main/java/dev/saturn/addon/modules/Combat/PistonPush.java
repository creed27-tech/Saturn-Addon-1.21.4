...
public class PistonPush extends Module {
    public PistonPush() {
        super(Categories.Combat, "piston-push", "Pushes people out of their safe holes.");
    }
    ...
    private void sendToggledMsg(String enemyMoved) {
    }
    ...
    private void sendPacket(PlayerActionC2SPacket lookAndOnGround) {
    }
