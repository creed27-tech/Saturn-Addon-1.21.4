...
public class DeathCrystal extends Module {
    ...
    public DeathCrystal() {
        super(Categories.Combat, "death-crystal", "Automatically places and blows up crystals. | Ported from BBCWare");
    }
