...
import static dev.saturn.addon.utils.lemon.entity.EntityInfo.getBlockPos;
...
public class NewSurround extends Module {
    ...
    public NewSurround() {
        super(Categories.Combat, "new-surround", "Surrounds you in blocks to prevent crystal damage");
    }
    @Override
