...
import dev.saturn.addon.utils.reaper.BedCode;
import dev.saturn.addon.utils.reaper.Wrapper;
import dev.saturn.addon.utils.reaper.combat.MineUtil;
import dev.saturn.addon.utils.reaper.player.Automationutils;
import dev.saturn.addon.utils.reaper.player.InvUtil;
import dev.saturn.addon.utils.reaper.world.BlockHelper;
import dev.saturn.addon.utils.reaper.world.EntityHelper;
...
public class BedAura2 extends Module {
    ...
    public BedAura2() {
        super(Categories.Combat, "bed-aura-2", "The best Bed Aura 2 | Ported from Reaper");
    }
        ...
        for (int index = 0; index < 3; index++) {
            ...
            for (CardinalDirection dir : CardinalDirection.values()) {
                ...
                if (predictMovement.get() && shouldPredict(target)) {
                    ...
                    centerPos = centerPos.add((int) plusX, (int) plusY, (int) plusZ);
                ...
                if (BlockUtils.canPlace(centerPos.offset(dir.toDirection()))) {
