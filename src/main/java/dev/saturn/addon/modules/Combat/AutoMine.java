...
public class AutoMine extends Module {
    public AutoMine() {
        super(Categories.Combat, "auto-mine", "Automatically mines blocks to destroy your enemies.");
    }
    ...
    private final SettingGroup sgAntiReager = settings.createGroup("Anti regear");
    ...
    //--------------------Anti-Surround--------------------//
    private final Setting<Priority> antiregear = sgAntiReager.add(new EnumSetting.Builder<Priority>()
            .name("Antiregear")
            .description("prevents enemies from getting a refill <in test>")
            .defaultValue(Priority.Normal)
            .build()
    );
    //--------------------Render--------------------//
    ...
    private void explodeUpdate() throws InterruptedException {
    ...
    private void sendPacket(PlayerActionC2SPacket attack) {
    }
    ...
    private void sendSequenced(Object o) {
    }
    ...
    private void interactBlock(Hand hand, Vec3d centerPos, Direction dir, BlockPos down) {
    }
    ...
    private boolean shouldExplode() {
        return switch (target.type) {
            ...
            case SurroundMiner, AntiBurrow, Manual, Antiregear -> false;
