...
public class MCP extends Module {
    public MCP() { super(Categories.Player, "MCP", "Lets you use items when you middle click. | Ported from Aurora");
    }
    ...
    private void sendDisableMsg(String unableToFindSpecifiedItem) {
    }
