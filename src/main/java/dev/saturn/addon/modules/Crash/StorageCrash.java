...
public class StorageCrash extends Module {
    ...
    public StorageCrash() {
        super(Saturn.Crash, "storage-crash", "Attempts to lag / crash servers by sending broken storage opening packets.");
    }
    ...
    private void onScreenOpen(OpenScreenEvent event) {
        ...
        if (!event.screen.shouldPause() && !(event.screen instanceof InventoryScreen) && (event.screen instanceof HandledScreen)) event.setCancelled(true);
    }
