...
import dev.saturn.addon.utils.griefingutils.CreativeUtils;
import dev.saturn.addon.utils.griefingutils.MiscUtil;
import dev.saturn.addon.utils.griefingutils.entity.EggGenerator;
...
public class WitherAdvertise extends Module {
    ...
    public WitherAdvertise() {
        super(Saturn.Griefing, "wither-advertise", "Spawns withers nearby with a name.");
    }
    ...
    private void postTick(TickEvent.Post event) {
        ...
        for (int i = 0; i < amount.get(); i++) {
            ...
            CreativeUtils.giveToEmptySlot(EggGenerator.WITHER.get(
