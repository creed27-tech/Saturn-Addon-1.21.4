...
import dev.saturn.addon.utils.griefingutils.ListMode;
...
public class AntiBlockEntityLag extends Module {
    ...
    public AntiBlockEntityLag() {
        super(Saturn.Griefing, "anti-block-entity-lag", "Lets you change the render distance of specified block entities.");
    }
