...
import static dev.saturn.addon.utils.bed.basic.EntityInfo.isOnGround;

public class BTTimerFall extends Module {
    private final SettingGroup sgGeneral = settings.getDefaultGroup();

    public static BTTimerFall INSTANCE;
    ...
    public BTTimerFall() {
        super(Saturn.PVE, "BT-timer-fall", "Falling faster with timer.");
        INSTANCE = this;
    }
