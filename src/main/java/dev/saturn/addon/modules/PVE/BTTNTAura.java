...
import static dev.saturn.addon.utils.bed.basic.EntityInfo.isSurrounded;

public class BTTNTAura extends Module {
    ...
    private final Setting<BTNotifications.Mode> n = sgNone.add(new EnumSetting.Builder<BTNotifications.Mode>().name("notifications").defaultValue(BTNotifications.Mode.Toast).build());
    ...
    public BTTNTAura() {
        super(Saturn.PVE, "BT-TNT-Aura", "Placing & igniting TNT around enemy");
    }
    ...
    private void igniteTNT(BlockPos pos, FindItemResult item) {
        ...
        // Adjusting the interactBlock call
