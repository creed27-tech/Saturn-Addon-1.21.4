...
import static dev.saturn.addon.utils.bed.basic.EntityInfo.getStack;

public class BTAutoBuild extends Module {
    ...
    public BTAutoBuild() {
        super(Saturn.PVE, "BT-auto-build", "Places build that you choose.");
    }
