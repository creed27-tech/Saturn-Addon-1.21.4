...
import dev.saturn.addon.utils.notware.player.InvHelper;
...
public class NWAutoBedCraft extends Module {
    ...
    public NWAutoBedCraft() {
        super(Saturn.PVP, "NW-auto-bed-craft", "mpvp meta smh");
    }
