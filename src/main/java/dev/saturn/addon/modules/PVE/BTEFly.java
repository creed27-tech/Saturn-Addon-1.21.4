...
public class BTEFly extends Module {
    ...
    public BTEFly() {
        super(Saturn.PVE, "BT-EFly", "Elytra Fly that works on ncp servers.");
    }
    ...
    private void onTick(TickEvent.Pre event) {
        ...
        // Fall flying check (updated for newer API versions)
        ...
        // Disable flight abilities if already enabled
