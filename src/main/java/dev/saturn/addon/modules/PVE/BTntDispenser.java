...
public class BTntDispenser extends Module {
    ...
    public BTntDispenser() {
        super(Saturn.PVE, "B+-tnt-dispenser", "Traps people in an obsidian and perform mass amount of TNT trolling on them.");
    }
