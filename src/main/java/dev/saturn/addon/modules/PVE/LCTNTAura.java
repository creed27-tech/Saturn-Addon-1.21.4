...
import static dev.saturn.addon.utils.lemon.entity.EntityInfo.isSurrounded;
import static dev.saturn.addon.utils.lemon.world.BlockInfo.getBlock;
import static dev.saturn.addon.utils.lemon.world.BlockInfo.isAir;

public class LCTNTAura extends ov4Module {
    ...
    public LCTNTAura() {
        super(Saturn.PVE, "LC-TNT-aura", "Placing & igniting TNT around enemy | Ported from Lemon Client");
    }
