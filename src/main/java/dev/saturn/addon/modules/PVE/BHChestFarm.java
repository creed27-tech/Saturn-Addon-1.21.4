...
import dev.saturn.addon.utils.bebra.Task;
...
import static dev.saturn.addon.utils.bebra.BlockInfo.*;
import static dev.saturn.addon.utils.bebra.EntityInfo.getBlockPos;

public class BHChestFarm extends Module {
    //private final SettingGroup sgGeneral = settings.getDefaultGroup();

    public BHChestFarm() {
        super(Saturn.PVE, "BH-chest-farm", "auto farm chests.");
    }
