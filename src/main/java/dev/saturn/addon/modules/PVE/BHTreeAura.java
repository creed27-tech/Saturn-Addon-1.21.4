...
public class BHTreeAura extends Module {
    ...
    public BHTreeAura() { // CopeTypes
        super(Saturn.PVE, "BH-tree-aura", "Plants trees around you");
    }
    ...
    private boolean canPlant(BlockPos pos) {
        ...
        if (b.equals(Blocks.GRASS_BLOCK) || b.equals(Blocks.GRASS_BLOCK) || b.equals(Blocks.DIRT) || b.equals(Blocks.COARSE_DIRT)) {
