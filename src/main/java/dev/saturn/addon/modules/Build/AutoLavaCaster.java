...
import dev.saturn.addon.modules.Movement.FlightAntikick;
import dev.saturn.addon.modules.Movement.TPFly;
...
public class AutoLavaCaster extends Module {
    ...
    public AutoLavaCaster() {
        super(Saturn.Build, "auto-lava-caster", "Make Layers of Cobble on your Stairs! Aim at the top of the block you want to lava on.");
    }
