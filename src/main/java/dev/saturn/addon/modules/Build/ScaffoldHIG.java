...
import dev.saturn.addon.utils.Build.ListMode;
...
public class ScaffoldHIG extends Module {
    ...
    public ScaffoldHIG() {
        super(Saturn.Build, "scaffold-HIG", "Scaffolds blocks under you.");
    }
    ...
    public void onTick(TickEvent.Pre event) {
        ...
        for (int i = 0; i <= (mc.player.getVelocity().x == 0.0 && mc.player.getVelocity().z == 0.0 ? 0 : ext.get()); i++) {
            ...
            if (keepY.get()) ((IVec3d) pos).meteor$setY(height.get() - 1.0); // Replaced | Might not work
