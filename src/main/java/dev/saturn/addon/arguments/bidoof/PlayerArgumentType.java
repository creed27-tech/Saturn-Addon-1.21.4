package dev.saturn.addon.arguments.bidoof;
...
import dev.saturn.addon.mixininterfaces.bidoof.IStringReader;
...
public class PlayerArgumentType {
    ...
    public static class UsernameArgumentType implements ArgumentType<String> {
        ...
        public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
            ...
            return CommandSource.suggestMatching((Iterable<String>) mc.world.getPlayers().stream().map(PlayerEntity::getName), builder);
        }
